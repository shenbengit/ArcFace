...
object FaceConstant {
    ...
    init {
        ...
        sFaceErrorMsgArray.put(
            ErrorInfo.MERR_ASF_ACTIVATION_QUANTITY_OUT_OF_LIMIT,
            "年度激活数量超出限制，次年清零"
        )
        ...
        sFaceErrorMsgArray.put(ErrorInfo.MERR_ASF_ACTIVEKEY_DEVICE_OUT_OF_LIMIT, "批量授权激活码设备数超过限制")
    ...
    init {
        ...
        sLivenessErrorMsgArray.put(LivenessInfo.DEPTH_IMAGE_ERROR, "深度图像异常")
